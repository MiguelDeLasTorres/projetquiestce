...
public class JacksonParser {
	...
	public StatExtension ChargerStats(String datapath)  throws IOException {

		byte[] jsonData = Files.readAllBytes(Paths.get(datapath));//lis les bytes du fichier
		ObjectMapper objectMapper = new ObjectMapper().enable(SerializationFeature.INDENT_OUTPUT);//crée une instance d'objectmapper


		StatExtension c = objectMapper.readValue(jsonData, StatExtension.class);//converti JSON String en object
		return c;
	}
	
	public void EnregistrerStats(String datapath, Object o) throws IOException {		
